      ...
      <header className="bg-dashboard-header border-b border-dashboard-border p-2 md:p-4">
        <div className="flex justify-between items-center px-2 md:px-4 py-2">
          <div className="flex items-center gap-2">
            <div className="relative">
              ...
              <input
                ...
                className="search-input pl-10 w-[120px] md:w-[180px]"
              />
            </div>
          ...
          <div className="hidden md:flex border-dashboard-border overflow-x-auto">
            <button className="px-4 py-2 text-gray-400 hover:border-b-2 border-[#26dbd6]">Overview</button>
            <button className="px-4 py-2 text-gray-400 hover:border-b-2 border-[#26dbd6]">Performance</button>
            <button className="px-4 py-2 text-gray-400 hover:border-b-2 border-[#26dbd6]">Overview</button>
            <button className="px-4 py-2 text-gray-400 hover:border-b-2 border-[#26dbd6]">Overview</button>
            <button className="px-4 py-2 text-gray-400 hover:border-b-2 border-[#26dbd6]">Overview</button>
          </div>
