...
export default function TokenPnLTable() {
  ...
  return (
    <div className="bg-[#000B13] rounded-xl border border-[#284c8f] overflow-hidden p-4">
      <h2 className="text-white text-xl font-semibold mb-4">Token PnL</h2>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 lg:gap-8 mb-4 lg:mb-0">
              <div className="text-center">
                ...
                <div className="flex items-center justify-center">
                  <div className="h-2 w-2 bg-[#26DBD6] rounded-full mr-1"></div>
                  <span className="text-sm text-[#26DBD6]">{wallet.blockchain}</span>
                </div>
              </div>
